...
export default function TransactionsTable() {
    const transactions = useMemo(() => {
        ...
        const baseTransactions = [...mockDataAggregations.transactions].sort(
            (a, b) =>
    ...
    return (
        <Card className="col-span-3 border-border bg-secondary/20 backdrop-blur-sm flex-1">
            <CardHeader>
                ...
                <div className="h-full overflow-auto">
                    <Table>
                        ...
                        <TableBody>
                            {transactions.map((tx) => {
                                const inputSymbol =
                                    TOKEN_MAP[tx.inputToken] || "UNKNOWN";
                                const outputSymbol =
                                    TOKEN_MAP[tx.outputToken] || "UNKNOWN";
